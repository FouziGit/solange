...
export const conversations: Conversation[] = [
  {
    ...
    messages: [
      ...
      {
        from: "them",
        text: "Oui, en parfait état. Je peux t'envoyer des photos détail.",
      },
  ...
  },
  {
    ...
    messages: [
      {
        from: "them",
        text: "Pièce incroyable. Tu ferais un petit geste sur le prix ?",
      },
    ...
    chat: [
      {
        handle: "maya.curates",
        seed: "maya-d-55",
        text: "La veste est incroyable 🖤",
      },
      {
        handle: "theo.grail",
        seed: "theo-grail-3",
        text: "Elle taille comment ?",
      },
