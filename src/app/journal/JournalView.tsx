          ...
          >
            <article className="relative aspect-[4/5] overflow-hidden ring-1 ring-bone/20 md:aspect-[2/1]">
              ...
              <div className="absolute inset-x-0 top-0 flex items-center justify-between border-b border-bone/15 px-5 py-3 md:px-8">
                <span className="overline text-[10px] text-bone/80">
                  {KIND_LABEL[cover.kind]}
                </span>
                <span className="overline text-[10px] text-bone/50">
                  {folio(0)} — À la une
                </span>
              </div>
                ...
                <div className="mt-1 flex items-center gap-3 border-t border-bone/20 pt-3">
                  ...
                  {cover.brand && (
                    <>
                      ...
                      />
                      <span className="overline hidden text-[10px] text-bone/60 md:inline">
                        {cover.brand}
                      </span>
                    </>
                  )}
              ...
              >
                ...
                >
                  ...
                  <div className="mt-3 flex items-center gap-3">
                    {a.brand && (
                      <span className="overline border border-bone/20 px-2 py-1 text-[9px] text-bone/70">
                        {a.brand}
                      </span>
                    )}
                    <span className="overline text-[9px] text-bone/45">
